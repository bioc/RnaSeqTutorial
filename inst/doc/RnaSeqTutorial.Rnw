...
the use of the \Rpackage{easyRNASeq} package and how more advanced
...
package. You'll probably want to avoid counting the same read multiple
times, \textit{e.g.} in overlapping exons.
